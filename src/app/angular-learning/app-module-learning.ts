...
1. Méthode qui dit console.log( hello wolrd!);
  2. Méthode qui permet de calculer la moyenne de 4 valeur d'entreé , les deux premiere seront sommé avant.private 
  
  3. Méthode qui créer une Map en fonction de parametre d'entrée et en sortie nous renvoie une clé valeur au choix'
...
3 eme exercice revoir les class : Comprendre l'heritage a travers. un exercice ou on souhaite créer.
